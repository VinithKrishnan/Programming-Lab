...
bool check_precedence_associativity(string op, string top)    {
    if (op == "++" or op == "--") {
        ...
        if(top == "(" or top == "&" or top == "|" or top == "^") return true;
        else return false;
...
vector<string> getPostFix(vector<string> token_expr)    {
    ...
    for(int i=0;i<token_expr.size();i++)    {
        ...
        else if(temp == "/" or temp == "*" or temp == "-" or temp == "+" or temp == "--" or temp == "++" or temp == "&" or temp == "|" or temp == "^" or temp == "%")
            {
...
while(i<input_expr.size())  {
    ...
    else if(temp == "*" or temp == "/" or temp == "(" or temp == ")"or temp == "&" or temp == "|" or temp == "^" or temp == "%")
    {
        postfix_expr.push_back(temp);
        i++;
    }
